...
const totalAshol = Number(item.ashol) || 0
  ...
  return (
    <Reorder.Item
      key={item._id}
      value={item}
      dragListener={false} // 👈 কার্ডের ওপর থেকে ড্রাগ ডিজেবল করা হলো
    ...
    >
      <div className="flex items-center gap-2 bg-amber-500 text-black p-3.5 rounded-2xl shadow-lg hover:bg-amber-400 transition">
        ...
        {/* 🔹 শুধুমাত্র এই আইকন চেপে ধরে সরাতে পারবে */}
        {isAdmin && (
          <div
            onPointerDown={(e) => dragControls.start(e)} // 👈 আইকনে টাচ করলেই কেবল ড্রাগ কাজ করবে
