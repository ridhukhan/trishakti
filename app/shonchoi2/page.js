  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 bg-amber-500 text-black p-3.5 rounded-2xl shadow-lg hover:bg-amber-400 transition">
        {/* 🔹 শুধুমাত্র এই আইকনটি চেপে ধরলেই ড্রাগ চালু হবে */}
        {isAdmin && (
          <div
            onPointerDown={(e) => dragControls.start(e)} // 👈 আইকনে টাচ/ক্লিক করলে ড্রাগ শুরু হবে
        ...
        <Link href={`/shonchoi2/${item._id}`} className="flex-1">
